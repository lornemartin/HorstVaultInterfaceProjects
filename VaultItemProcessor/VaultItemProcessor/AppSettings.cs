...
public static class AppSettings
{
    ...
    public static readonly string SettingsFilePath = Environment.GetFolderPath(Environment.SpecialFolder.CommonApplicationData) + @"\Vault Item Processor\AppSettings.xml";
