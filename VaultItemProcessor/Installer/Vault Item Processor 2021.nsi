...
!define APP_NAME "Vault Item Processor 2021"
!define COMP_NAME "Horst Welding"
!define VERSION "5.00.00.00"
!define COPYRIGHT "Lorne Martin  © 2021"
!define DESCRIPTION ""
!define INSTALLER_NAME "M:\Custom Code 2021 Deployment Files\VaultItemProcessor\Vault Item Processor Setup.exe"
!define MAIN_APP_EXE "Vault Item Processor 2021.exe"
...
InstallDir "$PROGRAMFILES\Vault Item Processor 2021"
...
!define MUI_STARTMENUPAGE_DEFAULTFOLDER "Vault Item Processor 2021"
...
CreateDirectory "$SMPROGRAMS\Vault Item Processor 2021"
CreateShortCut "$SMPROGRAMS\Vault Item Processor 2021\${APP_NAME}.lnk" "$INSTDIR\${MAIN_APP_EXE}"
CreateShortCut "$SMPROGRAMS\Vault Item Processor 2021\Uninstall ${APP_NAME}.lnk" "$INSTDIR\uninstall.exe"

!ifdef WEB_SITE
WriteIniStr "$INSTDIR\${APP_NAME} website.url" "InternetShortcut" "URL" "${WEB_SITE}"
CreateShortCut "$SMPROGRAMS\Vault Item Processor 2021\${APP_NAME} Website.lnk" "$INSTDIR\${APP_NAME} website.url"
!endif
!endif
...
!ifndef REG_START_MENU
Delete "$SMPROGRAMS\Vault Item Processor 2021\${APP_NAME}.lnk"
Delete "$SMPROGRAMS\Vault Item Processor 2021\Uninstall ${APP_NAME}.lnk"
!ifdef WEB_SITE
Delete "$SMPROGRAMS\Vault Item Processor 2021\${APP_NAME} Website.lnk"
!endif
RmDir "$SMPROGRAMS\Vault Item Processor 2021"
!endif
