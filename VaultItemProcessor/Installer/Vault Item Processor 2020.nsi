...
!define APP_NAME "Vault Item Processor 2020"
!define COMP_NAME "Horst Welding"
!define VERSION "4.00.00.00"
!define COPYRIGHT "Lorne Martin  © 2020"
!define DESCRIPTION ""
!define INSTALLER_NAME "M:\Custom Code 2020 Deployment Files\VaultItemProcessor\Vault Item Processor Setup.exe"
!define MAIN_APP_EXE "Vault Item Processor 2020.exe"
...
InstallDir "$PROGRAMFILES\Vault Item Processor 2020"
...
!define MUI_STARTMENUPAGE_DEFAULTFOLDER "Vault Item Processor 2020"
...
StrCpy $INSTDIR "$PROGRAMFILES\Vault Item Processor 2020"
SetOutPath "$INSTDIR"
...
File "C:\Users\lorne\source\repos\Vault Interface Projects\VaultItemProcessor\VaultItemProcessor\bin\Debug\Autodesk.DataManagement.Client.Framework.xml"
File "C:\Users\lorne\source\repos\Vault Interface Projects\VaultItemProcessor\VaultItemProcessor\bin\Debug\Autodesk.Connectivity.LicenseWrapper.dll"
...
File "C:\Users\lorne\source\repos\Vault Interface Projects\VaultItemProcessor\VaultItemProcessor\bin\Debug\DevExpress.Printing.v18.2.Core.dll"
...
File "C:\Users\lorne\source\repos\Vault Interface Projects\VaultItemProcessor\VaultItemProcessor\bin\Debug\Vault Item Processor 2020.exe"
File "C:\Users\lorne\source\repos\Vault Interface Projects\VaultItemProcessor\VaultItemProcessor\bin\Debug\Vault Item Processor 2020.exe.config"
File "C:\Users\lorne\source\repos\Vault Interface Projects\VaultItemProcessor\VaultItemProcessor\bin\Debug\Vault Item Processor 2020.pdb"
...
File "C:\Users\lorne\source\repos\Vault Interface Projects\Vault 2020 SDK Binaries\AdskLicensingSDK_2.dll"

SetOutPath "$APPDATA\Autodesk\Vault 2020\Extensions\ItemExport"
...
SetShellVarContext all
SetOutPath "$APPDATA\Autodesk\Vault 2020\Extensions\DirectView"
...
CreateDirectory "$SMPROGRAMS\Vault Item Processor 2020"
CreateShortCut "$SMPROGRAMS\Vault Item Processor 2020\${APP_NAME}.lnk" "$INSTDIR\${MAIN_APP_EXE}"
CreateShortCut "$SMPROGRAMS\Vault Item Processor 2020\Uninstall ${APP_NAME}.lnk" "$INSTDIR\uninstall.exe"

!ifdef WEB_SITE
WriteIniStr "$INSTDIR\${APP_NAME} website.url" "InternetShortcut" "URL" "${WEB_SITE}"
CreateShortCut "$SMPROGRAMS\Vault Item Processor 2020\${APP_NAME} Website.lnk" "$INSTDIR\${APP_NAME} website.url"
!endif
!endif
...
Delete "$INSTDIR\DevExpress.Printing.v18.2.Core.dll"
...
Delete "$INSTDIR\Vault Item Processor 2020.exe"
Delete "$INSTDIR\Vault Item Processor 2020.exe.config"
Delete "$INSTDIR\Vault Item Processor 2020.pdb"
Delete "$INSTDIR\VaultAccess.dll"
Delete "$INSTDIR\VaultAccess.dll.config"
Delete "$INSTDIR\VaultAccess.pdb"
Delete "$INSTDIR\AdskLicensingSDK_2.dll"
Delete "$INSTDIR\Autodesk.Connectivity.LicenseWrapper.dll"
...
!ifndef REG_START_MENU
Delete "$SMPROGRAMS\Vault Item Processor 2020\${APP_NAME}.lnk"
Delete "$SMPROGRAMS\Vault Item Processor 2020\Uninstall ${APP_NAME}.lnk"
!ifdef WEB_SITE
Delete "$SMPROGRAMS\Vault Item Processor 2020\${APP_NAME} Website.lnk"
!endif
RmDir "$SMPROGRAMS\Vault Item Processor 2020"
!endif
