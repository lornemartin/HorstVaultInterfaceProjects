...
namespace HorstMFG.Infrastructure.Data.Migrations
{
    ...
    [Migration("20260325103659_NestingRedesign")]
    partial class NestingRedesign
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("HorstMFG.Core.Entities.BatchItem", b =>
                {
                    ...
                    b.Property<int?>("RadanIdAssignmentId")
                        .HasColumnType("integer");
                    ...
                    b.HasIndex("RadanIdAssignmentId");
            ...
            modelBuilder.Entity("HorstMFG.Core.Entities.BatchItem", b =>
                {
                    ...
                    b.HasOne("HorstMFG.Core.Entities.RadanIdAssignment", "RadanIdAssignment")
                        .WithMany()
                        .HasForeignKey("RadanIdAssignmentId");
